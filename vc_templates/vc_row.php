...
if('No' !== $atts['enable_container']){
	$css_classes[] = 'container m-auto';
}
...
if(!empty($atts['section_index'])){
	$wrapper_attributes[] = 'data-scroll-index="' . $atts['section_index'] . '"';
}
...
if('Yes' == $atts['enable_overlay']){
	$wrapper_attributes[] = 'data-overlay-dark="8"'; 
}
